...
INPUT_ROOT="${INPUT_ROOT:-${ROOT}/data/synth_high40_sources}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${ROOT}/data/tokenized_dfm5_synth_high40}"
WORKERS="${WORKERS:-1}"

cd "${ROOT}"
python scripts/build_synth_high40_source_tree.py --force --output "${INPUT_ROOT}"
