...
0.1.5 (build 10) bundles DFM Mimir v1.5 Q4_K_M from
...
The catalog also includes v1.5 Q8_0 and BF16, retaining the original model entries.
The earlier releases described below keep their original bundled models.
